    ...
    const app = new Vue({
      ...
      methods: {
        getComments() {
          ...
          .then((response) => {
            //arrow funtions are used because if not then `this` parameter will not be available under .then function instead of this app should be used as in app.comments
